...
- A colourblind-safe palette (validated data-viz reference palette): a single-hue blue
  sequential scale for the map, blue/orange for residential/office. Meaning is never
  colour-alone — the map legend gives explicit numeric ranges and every value is in a table.
