...
def test_aggregate_results_stock_weights_time_series_arrays(global_parameters: dict) -> None:
    ...
    scalar_cols = [
        ...
        "population",
        "E_cooling_kWh",
        f"E_cooling_capped_at_{cap}th_percentile_kWh",
        f"E_cooling_capped_at_{cap}th_percentile_Wh_m2",
        "P_cooling_peak_kW",
        f"P_cooling_peak_{cap}th_percentile_kW",
        f"P_cooling_peak_{cap}th_percentile_W_m2",
        "electricity_use_kWh",
        "GHG_emissions_electricity_kgCO2eq",
        "GHG_emissions_refrigerant_leaks_kgCO2eq",
        "GHG_emissions_production_phase_kgCO2eq",
